...
--f nie dziala :(
SELECT ST_Area(a.geometria) 
FROM budynki a, budynki b
WHERE ST_Distance(a.geometria, b.geometria)>0.5
AND a.nazwa='BuildingC' AND b.nazwa='BuildingB'

 --g 
 ST_Distance(a.geometria, b.geometria)>0.5